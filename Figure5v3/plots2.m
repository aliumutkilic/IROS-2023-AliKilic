...
axis([-0.1,9,-0.1,1.3])
hold on;
scatter(foot_vector,zeros(1,length(30)),'.','Color','k')
hold on;
scatter(start_step,start_step_y,'.','Color','r');
hold on
scatter(mid_step_x,mid_step_y,'.','Color','b');
%scatter(end_step,zeros(1,length(30)))
